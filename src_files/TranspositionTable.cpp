 ...
 * @return
 */
bool TranspositionTable::put(U64 zobrist, Score score, Move move, NodeType type, Depth depth, Score eval, Score avgE) {
    ...
    if (enP->zobrist == 0) {
        enP->set(key, score, move, type, depth, eval, avgE);
