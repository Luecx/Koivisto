...
TimeManager::TimeManager(int white, int black, int whiteInc, int blackInc, int movesToGo, Board* board) : 
    ...
    upperTimeBound = board->getActivePlayer() == WHITE ? (int(white / division)*3 + std::min(white * 0.9 + whiteInc, whiteInc * 2.0) - 25)
                                                       : (int(black / division)*3 + std::min(black * 0.9 + blackInc, blackInc * 2.0) - 25);
