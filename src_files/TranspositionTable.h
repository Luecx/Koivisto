...
struct Entry {
    ...
    void set(bb::U32 p_key, bb::Score p_score, move::Move p_move, NodeType p_type, bb::Depth p_depth, bb::Score p_eval, bb::Score p_oldScore) {
        this->zobrist = p_key;
        this->score   = p_score;
        this->move    = p_move;
        this->type    = p_type;
    ...
    bb::Score   eval;  	    // 16 bit
    bb::Score   oldS;       // 16 bit -> 128 bit = 16 byte
};
...
class TranspositionTable {
    ...
    bool put(bb::U64 zobrist, bb::Score score, move::Move move, NodeType type, bb::Depth depth, bb::Score eval, bb::Score oldScore);
