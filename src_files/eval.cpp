    ...
    for (int i = 0; i < 64; i++) {
        for (int kside = 0; kside < 2; kside++) {
            fast_pawn_psqt[WHITE][psqt_kingside_indexing(kside, kside)][i] =
                psqt_pawn_same_side_castle[pst_index_white(i, kside)] + piece_values[PAWN];
            fast_pawn_psqt[BLACK][psqt_kingside_indexing(kside, kside)][i] =
                psqt_pawn_same_side_castle[pst_index_black(i, kside)] + piece_values[PAWN];
            fast_pawn_psqt[WHITE][psqt_kingside_indexing(kside, 1 - kside)][i] =
                psqt_pawn_opposite_side_castle[pst_index_white(i, kside)] + piece_values[PAWN];
            fast_pawn_psqt[BLACK][psqt_kingside_indexing(1 - kside, kside)][i] =
                psqt_pawn_opposite_side_castle[pst_index_black(i, kside)] + piece_values[PAWN];
            
            fast_knight_psqt[WHITE][psqt_kingside_indexing(kside, kside)][i] =
                psqt_knight_same_side_castle[pst_index_white(i, kside)] + piece_values[KNIGHT];
            fast_knight_psqt[BLACK][psqt_kingside_indexing(kside, kside)][i] =
                psqt_knight_same_side_castle[pst_index_black(i, kside)] + piece_values[KNIGHT];
            fast_knight_psqt[WHITE][psqt_kingside_indexing(kside, 1 - kside)][i] =
                psqt_knight_opposite_side_castle[pst_index_white(i, kside)] + piece_values[KNIGHT];
            fast_knight_psqt[BLACK][psqt_kingside_indexing(1 - kside, kside)][i] =
                psqt_knight_opposite_side_castle[pst_index_black(i, kside)] + piece_values[KNIGHT];
            
            fast_bishop_psqt[WHITE][psqt_kingside_indexing(kside, kside)][i] =
                psqt_bishop_same_side_castle[pst_index_white(i, kside)] + piece_values[BISHOP];
            fast_bishop_psqt[BLACK][psqt_kingside_indexing(kside, kside)][i] =
                psqt_bishop_same_side_castle[pst_index_black(i, kside)] + piece_values[BISHOP];
            fast_bishop_psqt[WHITE][psqt_kingside_indexing(kside, 1 - kside)][i] =
                psqt_bishop_opposite_side_castle[pst_index_white(i, kside)] + piece_values[BISHOP];
            fast_bishop_psqt[BLACK][psqt_kingside_indexing(1 - kside, kside)][i] =
                psqt_bishop_opposite_side_castle[pst_index_black(i, kside)] + piece_values[BISHOP];
            
            fast_rook_psqt[WHITE][psqt_kingside_indexing(kside, kside)][i] =
                psqt_rook_same_side_castle[pst_index_white(i, kside)] + piece_values[ROOK];
            fast_rook_psqt[BLACK][psqt_kingside_indexing(kside, kside)][i] =
                psqt_rook_same_side_castle[pst_index_black(i, kside)] + piece_values[ROOK];
            fast_rook_psqt[WHITE][psqt_kingside_indexing(kside, 1 - kside)][i] =
                psqt_rook_opposite_side_castle[pst_index_white(i, kside)] + piece_values[ROOK];
            fast_rook_psqt[BLACK][psqt_kingside_indexing(1 - kside, kside)][i] =
                psqt_rook_opposite_side_castle[pst_index_black(i, kside)] + piece_values[ROOK];
            
            fast_queen_psqt[WHITE][psqt_kingside_indexing(kside, kside)][i] =
                psqt_queen_same_side_castle[pst_index_white(i, kside)] + piece_values[QUEEN];
            fast_queen_psqt[BLACK][psqt_kingside_indexing(kside, kside)][i] =
                psqt_queen_same_side_castle[pst_index_black(i, kside)] + piece_values[QUEEN];
            fast_queen_psqt[WHITE][psqt_kingside_indexing(kside, 1 - kside)][i] =
                psqt_queen_opposite_side_castle[pst_index_white(i, kside)] + piece_values[QUEEN];
            fast_queen_psqt[BLACK][psqt_kingside_indexing(1 - kside, kside)][i] =
                psqt_queen_opposite_side_castle[pst_index_black(i, kside)] + piece_values[QUEEN];
        }
