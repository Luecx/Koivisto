...
EvalScore psqt_king[64] = {
    M(   89, -153), M(  195,  -66), M(  197,  -15), M(  130,  -25), M(   74,  -21), M(  168,  -37), M(  114,  -54), M(  271, -175), 
    M(  -19,  -29), M(  126,   14), M(  290,  -29), M(  122,  -11), M(  195,  -29), M(  172,  -10), M(  124,   10), M(  105,  -31), 
    M(   43,   12), M(  181,    9), M(  170,   11), M(  120,    8), M(  170,   -3), M(  164,   12), M(  149,   15), M(  124,  -13), 
    M(   48,    5), M(  122,    8), M(  115,   20), M(   50,   28), M(   89,   22), M(  136,   17), M(  121,   -2), M(   -7,    2), 
    M(    4,  -16), M(  104,   -2), M(  103,   10), M(   16,   31), M(   43,   35), M(   60,   20), M(   86,    2), M(   29,  -21), 
    M(   61,  -28), M(   14,    1), M(   51,    8), M(   12,   28), M(   31,   25), M(   34,   19), M(   40,    0), M(    6,   -8), 
    M(   51,  -25), M(   36,  -12), M(   36,   -5), M(  -26,   14), M(   28,    8), M(    1,   14), M(   44,  -11), M(   51,  -28), 
    M(   40,  -67), M(   72,  -39), M(   41,  -22), M(  -37,  -18), M(   53,  -63), M(  -24,   -3), M(   62,  -31), M(   68,  -84),
};
