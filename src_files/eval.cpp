...
bb::Score Evaluator::evaluate(Board* b) {
    ...
    materialScore = b->getMaterial();
    
//    while (k) {
//        square = bitscanForward(k);
//        materialScore += fast_pawn_psqt[WHITE][psqtKingsideIndex][square];
//        k = lsbReset(k);
//    }
//
...
//    while (k) {
//        square = bitscanForward(k);
//        materialScore += fast_pawn_psqt[BLACK][psqtKingsideIndex][square];
//        k = lsbReset(k);
//    }
    k = whitePassers;
    while (k) {
...
//        materialScore += fast_knight_psqt[WHITE][psqtKingsideIndex][square];
...
//        materialScore += fast_knight_psqt[BLACK][psqtKingsideIndex][square];
...
//        materialScore += fast_bishop_psqt[WHITE][psqtKingsideIndex][square];
...
//        materialScore += fast_bishop_psqt[BLACK][psqtKingsideIndex][square];
...
//        materialScore += fast_rook_psqt[WHITE][psqtKingsideIndex][square];
...
//        materialScore += fast_rook_psqt[BLACK][psqtKingsideIndex][square];
...
//        materialScore += fast_queen_psqt[WHITE][psqtKingsideIndex][square];
...
//        materialScore += fast_queen_psqt[BLACK][psqtKingsideIndex][square];
...
//        materialScore += fast_king_psqt[WHITE][square];
...
//        materialScore += fast_king_psqt[BLACK][square];
