...
EvalScore BISHOP_PIECE_SAME_SQUARE_E    = M(    0,    4);
EvalScore QUEEN_DISTANCE_ENEMY_KING     = M(    3,  -25);
EvalScore KING_CLOSE_OPPONENT           = M(  -12,   42);
EvalScore KING_PAWN_SHIELD              = M(   28,    4);
EvalScore CASTLING_RIGHTS               = M(   26,   -8);
