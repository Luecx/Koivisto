...
EvalScore psqt_pawn_same_side_castle[64] = {
    ...
    M( -12,  -4), M(  23,   8), M(  11,  31), M( -10,  38), M( -11,  26), M( -19,  24), M( -20,  27), M( -19,  35),
    M(   7,   2), M(  21,   4), M(  11,  19), M(   7,  21), M(  -2,   8), M( -13,  15), M( -20,  19), M( -19,  26),
    M(   3,  10), M(  16,  17), M(  15,  13), M(  19,   8), M(   7,   6), M(   2,   8), M( -17,  32), M( -15,  35),
    M(  17,  18), M(  24,  25), M(  46,   8), M(  35,   8), M(  24,   0), M(   3,  28), M(  -5,  43), M( -10,  56),
    M(  20,  36), M(  78,  28), M( 118,  11), M(  49,  14), M(  35,  22), M(  33,  57), M(  19,  83), M( -12,  96),
    M(   6, 128), M(  -4, 117), M( 181,  68), M( 204,  67), M( 185, 104), M( 182, 140), M( 177, 168), M( 192, 169),
    M(   0,   0), M(   0,   0), M(   0,   0), M(   0,   0), M(   0,   0), M(   0,   0), M(   0,   0), M(   0,   0),
};

EvalScore psqt_pawn_opposite_side_castle[64] = {
    M(   0,   0), M(   0,   0), M(   0,   0), M(   0,   0), M(   0,   0), M(   0,   0), M(   0,   0), M(   0,   0),
    M(   7,  26), M(  31,  21), M(  11,  29), M( -14,  39), M( -22,  38), M( -31,  43), M( -47,  46), M( -45,  41),
    M(  21,  22), M(  30,  17), M(  11,  24), M(  -2,  25), M( -12,  25), M( -21,  32), M( -49,  35), M( -45,  34),
    M(  18,  43), M(  15,  43), M(  14,  29), M(  11,  22), M(   9,  19), M(  -2,  26), M( -29,  35), M( -37,  31),
    M(  12,  82), M(  14,  72), M(  19,  51), M(  20,  32), M(  36,  13), M(  39,  13), M( -11,  33), M( -20,  30),
    M(  -2, 152), M(  37, 143), M(  36, 113), M(  30,  66), M(  60,  19), M(  93,   1), M(  73,   8), M(   1,  31),
    M( 178, 236), M( 200, 230), M( 165, 210), M( 174, 158), M( 192,  89), M( 192,  42), M(  47,  82), M(  37,  96),
    M(   0,   0), M(   0,   0), M(   0,   0), M(   0,   0), M(   0,   0), M(   0,   0), M(   0,   0), M(   0,   0),
};

EvalScore psqt_knight_same_side_castle[64] = {
    M( -38, -62), M(  -5, -48), M(   2, -29), M(   5, -26), M(   3, -25), M( -10, -42), M(  -6, -72), M( -55, -65),
    ...
    M(  11, -11), M( -52,  24), M(  62,  -1), M(  34,  21), M(  42,  24), M(  19,  -6), M( -32,  -8), M( -25, -30),
    M(-164, -53), M( -98,  17), M(-135,  58), M( -18,  15), M( -54,  18), M(-165,  43), M(-161,  14), M(-266, -28),
};

EvalScore psqt_knight_opposite_side_castle[64] = {
    M( -46, -69), M( -33, -13), M(   1, -24), M(   7,  -4), M(   3,   0), M( -13, -15), M( -11, -36), M( -61, -23),
    M( -12, -31), M( -17,  -6), M(   1, -13), M(   9,  -2), M(  13,   3), M(  -6,   1), M( -39,  15), M( -42, -15),
    M( -15, -27), M(  -3,   0), M(  12,   6), M(  12,  27), M(  19,  29), M(   2,  15), M(  -1,  -4), M( -26, -20),
    M(   6,  -2), M(  25,  12), M(  25,  32), M(  22,  44), M(  35,  42), M(  21,  38), M(  32,  18), M(   8,  -3),
    M(   1,   4), M(  15,  12), M(  40,  29), M(  48,  51), M(  25,  59), M(  39,  52), M(  15,  23), M(  17,   0),
    M( -29,  -9), M(  26,   7), M(  49,  30), M(  49,  40), M(  70,  36), M(  91,  37), M(  44,   4), M(  12, -14),
    M( -13, -22), M(  -4,  -3), M(  57, -10), M(  82,  19), M(  56,  15), M(  52,   4), M(  -8,   0), M(  19, -28),
    M(-204, -61), M(-153,  22), M(-130,  35), M( -41,  25), M(  -4,   1), M( -86,  26), M( -42,   6), M(-202, -25),
};
...
EvalScore psqt_bishop_same_side_castle[64] = {
    ...
    M( -29,  25), M( -12,  32), M(  -1,  28), M(   1,  33), M(  24,  22), M( -16,  20), M(  -9,  13), M( -48,  17),
    M( -20,  26), M(  18,  35), M(  26,  36), M(  22,  26), M(  -3,  20), M(   9,  16), M( -27,  27), M( -33,  11),
    M( -55,  24), M( -26,  29), M(   4,  22), M( -37,  30), M( -47,  30), M( -38,  29), M( -39,  26), M( -86,  32),
    M( -69,  28), M( -25,  17), M(-151,  38), M(-115,  40), M(-136,  46), M(-147,  43), M(-117,  52), M( -89,  44),
};
...
EvalScore psqt_bishop_opposite_side_castle[64] = {
    ...
    M(  14,  11), M(  28,  19), M(  33,  23), M(   6,  26), M(   4,  33), M( -13,  28), M(  -8,  21), M( -21,  25),
    M(  -9,  22), M(  10,  30), M(  10,  32), M(  37,  30), M(  12,  38), M(   2,  35), M(  -6,  25), M(  -5,  18),
    M( -16,  38), M(   5,  37), M(  19,  38), M(  29,  40), M(  50,  38), M(  16,  32), M(  20,  37), M(  -6,  24),
    M( -23,  37), M(  13,  41), M(  18,  39), M(  27,  39), M(  54,  35), M(  71,  37), M(  48,  29), M(   3,  25),
    M( -62,  44), M( -44,  53), M( -12,  47), M( -42,  48), M( -18,  45), M(  46,  25), M(   4,  32), M( -54,  26),
    M( -71,  67), M( -87,  50), M( -87,  48), M( -89,  58), M(-120,  51), M( -97,  49), M(   7,  35), M( -25,  48),
};

EvalScore psqt_rook_same_side_castle[64] = {
    M( -16, -10), M(  16,   3), M(  20,   6), M(  21,  -1), M(  21,   2), M(  11,   9), M(   3,   7), M(  -6,   2),
    M( -81,  10), M(   9,  -6), M(  20, -10), M(   5,   0), M(   3,   2), M(  -7,   8), M( -10,   0), M( -45,   8),
    M( -20,  -1), M(  22,  17), M(   5,  16), M(  -3,  11), M(  -3,  16), M( -18,  22), M( -10,  21), M( -25,  13),
    M( -11,  26), M(  21,  36), M(   3,  41), M(  -2,  34), M(  -4,  38), M( -14,  42), M( -15,  44), M( -18,  30),
    M(  29,  40), M(  47,  40), M(  49,  43), M(  36,  40), M(  45,  39), M(  17,  46), M(   7,  42), M(  -3,  44),
    M(  48,  45), M( 120,  27), M( 108,  42), M(  83,  29), M(  59,  38), M(  30,  50), M(  42,  38), M(  -7,  53),
    M(  49,  52), M(  59,  56), M( 125,  35), M(  42,  66), M(  43,  64), M(  24,  66), M(  -5,  70), M(   2,  62),
    M( 100,  46), M(  92,  51), M( 107,  50), M(  31,  61), M(  16,  66), M(   9,  70), M(  28,  63), M(  26,  60),
};

EvalScore psqt_rook_opposite_side_castle[64] = {
    M( -29,  18), M(   3,  15), M(  11,  16), M(  19,  11), M(  23,   6), M(  31,  12), M(  29,   8), M(   1,   9),
    M( -80,  22), M( -22,   9), M(  -3,   9), M(  -2,  17), M(   3,  15), M(  14,  12), M(  23,   2), M( -31,  15),
    M( -35,  16), M(   9,  20), M( -16,  27), M( -11,  29), M( -11,  27), M(   0,  29), M(  11,  26), M(  -2,  13),
    M(  -9,  35), M(  26,  34), M(  -2,  47), M(  -4,  51), M(  -2,  43), M(   0,  53), M(   9,  45), M(  -1,  32),
    M(  25,  46), M(  34,  40), M(  49,  39), M(  55,  49), M(  45,  46), M(  44,  56), M(  45,  40), M(  46,  34),
    M(  37,  48), M(  87,  26), M(  69,  45), M(  82,  40), M(  91,  40), M( 102,  44), M( 121,  26), M(  57,  37),
    M(  47,  52), M(  54,  53), M(  63,  55), M(  55,  71), M(  65,  61), M( 137,  32), M(  64,  48), M(  56,  44),
    M( 118,  30), M(  91,  45), M(  74,  53), M(  52,  60), M(  68,  53), M( 149,  30), M( 105,  42), M(  59,  56),
};

EvalScore psqt_queen_same_side_castle[64] = {
    M( -32, -29), M( -23, -42), M( -13, -32), M(   8, -36), M(   1,   1), M(  -3, -25), M(  -6, -24), M( -13,  -9),
    M( -25, -25), M(  13, -85), M(  21, -80), M(   7, -18), M(   6,  -8), M(   8, -33), M(   1, -16), M( -11, -12),
    ...
    M( -38, 111), M(  40,  76), M(  14,  84), M(  22,  51), M(  -7,  32), M( -31,  43), M( -31,  39), M( -47,  63),
    M(  22,  92), M( -49, 164), M(  98,  30), M( -62, 118), M( -59,  91), M( -34,  59), M( -87, 103), M( -45,  76),
    M(  56,  45), M(  23,  88), M(  43,  54), M( -17,  65), M( -17,  57), M( -27,  71), M( -30,  75), M( -45,  76),
};

EvalScore psqt_queen_opposite_side_castle[64] = {
    M( -42,   5), M( -22, -14), M(  -7, -32), M(  -1,   1), M(  -4,  16), M(  -8,   7), M( -13,  43), M( -12,  26),
    M( -44, -10), M( -10, -17), M(  22, -48), M(  15,  12), M(  10,   2), M(  17,  -9), M(  21,  -2), M(   9,  22),
    M( -25,  34), M(   8,  23), M(   8,  40), M(   6,  31), M(   6,  26), M(  12,  34), M(  22,  24), M(  22,  27),
    M( -14,  51), M(   2,  61), M(  -9,  73), M(   1,  91), M(  -1,  75), M(  14,  64), M(  22,  54), M(  32,  36),
    M(  -6,  61), M( -19,  93), M( -13,  68), M( -10, 106), M(  12,  96), M(  30,  78), M(  47,  74), M(  32,  55),
    M( -20,  90), M(   3,  56), M(  15,  62), M(   4,  84), M(  41,  90), M(  18, 121), M(  75,  40), M(  10,  65),
    M( -13,  79), M( -53, 130), M(  -6,  94), M( -47, 136), M( -65, 162), M(  82,  61), M( -15, 116), M(  27,  56),
    M(   5,  73), M(   8,  88), M(  -1,  90), M( -22, 108), M( -13, 103), M( 112,  26), M(  17,  82), M(  34,  52),
};

EvalScore psqt_king[64] = {
    M( -28, -94), M( 129, -50), M(  79, -21), M( 118, -14), M(  83, -24), M(  50, -13), M(  47,  -8), M(-143, -64),
    M(  16, -30), M( 119,  10), M( 202, -14), M( 193, -20), M( 149, -13), M( 173,  -9), M(  60,  24), M(  22, -28),
    M(  36,   1), M( 137,  17), M( 191,   6), M( 170,   0), M( 172,  -4), M( 186,   6), M( 124,  18), M(  27,  -3),
    M( -14,  13), M(  91,   9), M( 122,  15), M(  93,  19), M( 107,  15), M( 120,  14), M(  77,   5), M( -55,  11),
    M( -20, -12), M(  74,  -3), M(  77,  16), M(  40,  27), M(  53,  28), M(  49,  19), M(  64,   3), M( -34, -11),
    M( -18, -11), M(   4,   2), M(  13,  15), M(   0,  27), M(  12,  26), M(   0,  23), M(   2,   6), M( -21,  -6),
    M(  38, -22), M(  13,  -6), M(   4,   6), M( -36,  17), M(  -9,  14), M( -22,  18), M(  18,  -5), M(  37, -28),
...
EvalScore mobilityBishop[14] = {
    ...
    M(   61,  111), M(   68,  112), M(   74,  111), M(   87,  107), M(   93,  127), M(  133,   86), };

EvalScore mobilityRook[15] = {
    M(   26,   22), M(   33,   40), M(   36,   58), M(   39,   74), M(   42,   87), M(   49,   93), M(   54,  101), M(   60,  102),
    M(   64,  106), M(   70,  111), M(   72,  115), M(   77,  118), M(   85,  118), M(   96,  107), M(  167,   73), };

EvalScore mobilityQueen[28] = {
    M(  -10, -164), M(    3,  -91), M(   10,   34), M(   15,   94), M(   18,  136), M(   20,  168), M(   21,  191), M(   25,  207),
    M(   29,  218), M(   30,  227), M(   34,  233), M(   35,  244), M(   38,  251), M(   38,  258), M(   37,  266), M(   34,  272),
    M(   33,  276), M(   32,  277), M(   33,  278), M(   40,  274), M(   43,  268), M(   42,  267), M(   31,  268), M(   46,  258),
    M(   -1,  276), M(   58,  245), M(   13,  293), M(   24,  299), };
...
EvalScore pinnedEval[15] {
    ...
    M(  -22,   23), M(   -3,   -8), M(  -42,   -4), M(  -15,    5), M(  -44,  -53),
    M(    0,   -3), M(    1,  -13), M(    2, -122), M(   42, -239), M(  -11,    9),
};

EvalScore passer_rank_n[16] {
    M(    0,    0), M(   -9,  -29), M(   -9,  -24), M(   -5,    2), M(   20,   25), M(   49,   66), M(    6,   27), M(    0,    0),
    M(    0,    0), M(    1,    2), M(  -42,  -51), M(  -45,  -11), M(  -29,  -14), M(   37,   -9), M(   79, -139), M(    0,    0),
};
