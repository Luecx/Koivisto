...
EvalScore piece_square_table[6][2][64]{
    ...
    {
        {
            M(  -28, -105), M(  138,  -34), M(   92,  -11), M(  135,    1), M(  101,  -10), M(   60,   -5), M(   51,   -9), M( -117,  -95),
            M(    8,  -32), M(  119,   10), M(  203,  -10), M(  198,  -14), M(  154,  -11), M(  176,   -6), M(   62,   24), M(   24,  -34),
            M(   31,   -2), M(  153,   10), M(  198,    0), M(  178,   -4), M(  179,   -7), M(  191,    1), M(  131,   12), M(   19,   -7),
            M(   -7,    6), M(  118,   -3), M(  133,    8), M(  104,   14), M(  116,   12), M(  129,    9), M(   83,    1), M(  -47,    4),
            M(  -20,  -17), M(   95,   -7), M(  103,   10), M(   59,   24), M(   77,   24), M(   72,   16), M(   85,    0), M(  -28,  -14),
            M(  -15,  -11), M(   18,    2), M(   40,   10), M(   24,   25), M(   36,   25), M(   32,   16), M(   15,    7), M(  -15,   -7),
            M(   35,  -20), M(   19,   -2), M(    6,   10), M(  -32,   20), M(   -7,   18), M(  -14,   20), M(   21,   -2), M(   36,  -25),
            M(   45,  -77), M(   48,  -37), M(   25,  -16), M(    6,  -27), M(   13,  -36), M(   -5,   -9), M(   57,  -34), M(   66,  -87),
        },
        {
