...
EvalScore piece_our_king_square_table[5][15*15]{
    ...
    {
        M(   30,   15), M(  -57,   15), M(    6,  -27), M(  -36,   24), M(  -27,   15), M(  -48,   -3), M(    0,    6), M(  -57,   15), M(  -24,    0), M(   -3,    3), M(   -9,    6), M(   -9,   12), M(   -6,    9), M(   21,    0), M(  -21,   21),
        M(  -93,   18), M(   -3,  -21), M(  -12,   -3), M(  -12,   12), M(  -15,    3), M(  -24,    3), M(   -9,   -3), M(   -9,   -3), M(   -9,   -6), M(  -21,    0), M(  -15,    0), M(   -6,    0), M(    0,    3), M(    3,    0), M(  -21,    9),
        M(  -12,  -12), M(    0,  -15), M(    0,   -6), M(   -9,    6), M(   -9,    3), M(   -6,    3), M(  -15,    0), M(  -12,   -3), M(  -15,   -3), M(   -9,   -3), M(   -6,   -3), M(   -9,    0), M(   -9,    0), M(  -12,    0), M(   -6,    3),
        M(  -36,   -9), M(   -6,   -6), M(   -6,    0), M(   -9,    3), M(   -6,    0), M(   -6,   -3), M(   -6,   -3), M(   -6,    0), M(   -6,   -3), M(   -6,   -3), M(   -9,    0), M(   -3,    0), M(   -3,   -3), M(    0,   -9), M(  -27,    6),
        M(  -12,   -9), M(   -9,   -9), M(   -9,    0), M(   -3,   -6), M(   -3,    0), M(    0,   -6), M(   -3,   -3), M(   -3,   -3), M(   -6,   -3), M(    0,   -6), M(    0,   -3), M(   -3,   -3), M(   -3,   -3), M(   -3,   -9), M(   -9,  -12),
        M(  -24,   -6), M(   -3,  -18), M(   -6,   -9), M(   -3,   -3), M(   -3,    0), M(   -3,    0), M(    0,    0), M(    3,    3), M(    0,    0), M(    0,    0), M(    0,   -3), M(   -3,   -3), M(    0,   -9), M(    0,   -6), M(   -9,  -12),
        M(  -27,   -3), M(  -21,   -3), M(   -6,   -6), M(   -3,   -3), M(   -3,    6), M(   -9,    6), M(   -3,    6), M(    0,    0), M(   -3,    6), M(   -3,    6), M(    0,    6), M(   -3,   -3), M(   -3,   -6), M(   -6,   -3), M(  -15,    3),
        M(   -6,    0), M(  -21,  -12), M(   -9,   -6), M(   -6,    3), M(   -6,    3), M(   -9,    9), M(    0,    3), M(    0,    0), M(    3,    3), M(   -6,   12), M(   -9,    9), M(  -12,    9), M(   -6,   -6), M(  -27,    3), M(  -24,   -6),
        M( -120,   12), M(  -87,   12), M(  -15,   -3), M(  -33,    9), M(  -15,   12), M(  -24,   12), M(   -6,   15), M(   -9,    6), M(  -15,   18), M(  -27,   18), M(  -18,   15), M(  -30,   12), M(  -21,    0), M(  -51,    6), M(  -30,   -3),
        M(   12,   -6), M( -186,   39), M(  -93,    9), M(  -18,    3), M(  -30,   15), M(  -39,   15), M(  -54,   18), M(  -24,   15), M(  -63,   18), M(  -36,   18), M(  -42,   24), M(  -30,   15), M(  -51,   12), M( -141,   21), M(    6,  -18),
        M(   87,  -42), M(  -87,   -3), M( -123,    9), M( -135,   24), M( -111,   30), M(  -96,   27), M( -114,   24), M(  -54,   15), M( -135,   30), M(  -99,   24), M(  -69,   36), M( -120,   27), M( -150,   33), M( -183,   36), M(  -66,   18),
        M(   21,    6), M(  -54,   21), M( -117,   33), M(  -21,   15), M(    9,   15), M(  -24,   24), M(  -99,   21), M( -114,   27), M( -165,   24), M(  -81,   21), M( -171,   36), M( -243,   51), M( -123,   33), M( -144,   36), M( -189,   -9),
        M( -540,  108), M(   12,   18), M(  -54,   66), M(   60,   33), M( -126,   39), M( -210,   60), M( -138,   27), M( -144,   12), M(  -66,    3), M( -117,   30), M(   -9,   18), M(  -18,   12), M( -168,   45), M(    3,    9), M(   75,   57),
        M(    6,   51), M( -243,   78), M(   72,   75), M(   45,   60), M(   93,   60), M(   30,   27), M( -177,   33), M(   45,  -24), M(   27,   60), M(  -12,   12), M(   27,   51), M(   60,   42), M(  -15,   18), M(   21,   42), M( -342,  -78),
        M(   15,    9), M(  135,  210), M(    0,   24), M( -111,    0), M(    9,   45), M(  138,  -48), M(   12,   -9), M(  123,  123), M(   54,   36), M(   21,  -36), M(  -27,  -18), M(   48,   45), M(   -6,   24), M(   12,  -27), M(  -96, -162),
    },
    {
...
EvalScore piece_opp_king_square_table[5][15*15]{
    ...
    {
        M( -429, -540), M(  120, -117), M(  -72,  249), M(  -72, -117), M(   45,   45), M( -138, -138), M(   96,  -30), M(   66,   57), M( -402, -108), M(   48,   33), M(  201,  201), M( -318, -138), M(    6,   -3), M(  -66, -144), M( -276, -540),
        M(    3,   39), M(   48,   33), M(   15,   -6), M(  -27,  -36), M(  -33,  -33), M(   18,  -27), M(   18,  -15), M(  -90,   24), M(  -69,  -30), M(  -27,    6), M(  -18,  -24), M(  -30,  -54), M(  -15,   27), M(   18,   57), M(  147,  165),
        M(  -27,  -51), M(  -18,  -33), M( -102,    3), M(   12,  -21), M(    9,  -12), M(  -42,   -3), M(  -42,  -18), M(  -15,    0), M(   -9,   -9), M(  -15,  -18), M(  -54,   -9), M(  -48,   -6), M(   -6,   -9), M(   90,  -78), M(  141,  -45),
        M(   12,   -9), M(  -21,  -21), M(  -33,   -9), M(  -87,    0), M(  -63,    6), M(  -18,  -12), M(  -39,  -15), M(  -30,    0), M( -132,    0), M(  -15,   -3), M(  -69,   -3), M( -126,    6), M(   -3,  -12), M(  -51,  -15), M(  -30,   48),
        M(  -21,  -27), M(   48,  -18), M(  -24,  -12), M(  -42,   -6), M(  -12,    0), M(  -66,    6), M(   27,   -6), M(  -57,   -3), M(    0,    3), M(  -21,   -3), M(  -66,    9), M(  -39,   -6), M(  -72,   -3), M(    3,   -6), M(   39,  -15),
        M(    3,   -6), M(  -12,   -9), M(  -60,    3), M(  -30,    0), M(  -27,   -3), M(  -36,    0), M(   84,    0), M(   21,   -6), M(  174,   -6), M(  -33,    3), M(  -42,    6), M(  -36,   12), M(  -42,    3), M(  -42,    3), M(   72,   -6),
        M(  -30,   24), M(    0,    6), M(  -24,   -3), M(   -9,   -3), M(   33,   -3), M(  120,   12), M(   15,   30), M(  -60,   36), M(   -6,   36), M(  225,   -3), M(   12,    3), M(   -9,    0), M(  -39,    6), M(  -24,    0), M(  -60,   24),
        M(  -24,   36), M(  -24,   21), M(   -6,    3), M(    6,    6), M(    6,   -3), M(   24,   -6), M(  -30,   36), M(    0,    0), M(  -24,   33), M(   15,   -3), M(    0,    0), M(   18,    0), M(  -21,    6), M(  -21,   15), M(   -9,    9),
        M(  -21,   15), M(  -12,    3), M(    0,    6), M(    3,    3), M(   15,    9), M(   42,    3), M(    3,   39), M(   -3,   21), M(    6,   36), M(   15,    9), M(   21,    3), M(    6,    3), M(   -6,    3), M(   -6,    6), M(  -15,    3),
        M(    3,    3), M(    6,    3), M(    9,    0), M(    3,    6), M(   12,    0), M(    3,   -6), M(   42,    0), M(   12,   -9), M(   33,    0), M(    3,  -12), M(    9,   -3), M(    3,    6), M(   -3,    9), M(    0,    3), M(    0,    9),
        M(  -12,    3), M(   -3,    9), M(   -6,    3), M(   -3,    6), M(    6,   12), M(   12,   -3), M(    6,    0), M(    0,   -6), M(    6,    0), M(    3,   -3), M(    6,    9), M(   -3,    6), M(    0,    3), M(    0,    6), M(   -9,   -3),
        M(  -15,   -3), M(   -6,   -3), M(   -3,    0), M(   -6,    3), M(   -6,    3), M(    3,    3), M(    0,    0), M(    6,    3), M(    0,    0), M(   -3,    6), M(   -6,    0), M(   -3,    3), M(    0,    0), M(    0,    3), M(   -3,    9),
        M(  -15,   12), M(   -6,  -12), M(   -3,  -12), M(    0,   -3), M(   -3,   -6), M(   -3,   -3), M(   -3,   -6), M(   -3,   -6), M(    0,   -6), M(   -3,   -3), M(   -3,   -3), M(    0,   -3), M(    0,   -6), M(    0,   -3), M(   -6,   -3),
        M(  -33,   48), M(   -9,   15), M(   -9,   -3), M(   -3,   -9), M(   -6,    0), M(   -3,   -6), M(    0,   -9), M(    0,   -9), M(   -3,   -3), M(    0,   -9), M(    0,   -6), M(   -3,   -6), M(   -3,    3), M(    0,   -3), M(   -6,  -12),
        M(   -6,   18), M(    9,  -21), M(    3,    3), M(    3,   -3), M(    3,   -3), M(    0,   -3), M(   -6,   -3), M(    3,   -9), M(    0,   -3), M(    3,   -6), M(    3,   -3), M(    9,  -15), M(    6,    3), M(    3,  -18), M(   24,  -30),
    },
    {
