...
EvalScore piece_opp_king_square_table[5][15*15]{
    ...
    {
        M(  -48,  -39), M(  -39,  -51), M(   24,   30), M(  171,  -96), M( -183,   81), M( -234,  129), M(   42,  -27), M(    3,   24), M(  -78,   90), M(   72,   69), M(   36,  -15), M( -261,   39), M(   51,   -6), M(  -51, -108), M( -138, -168),
        M(   15,    9), M(  -39,  -42), M(   21,   30), M(   24,   33), M(  129,  -54), M(    0,    9), M(   -3,    3), M(   36,   -9), M( -114,   27), M(    0,   -3), M(  -21,   18), M(   21,    6), M(   60,  -93), M(  -81,  -69), M(  -72,  -84),
        M(  -81,  -69), M(   -3,  -48), M(  -69,  -69), M(   60,  -90), M(  -18,  -12), M(    6,  -90), M(    0,   -6), M(   57,  -45), M(  -36,  -21), M(   -9,  -33), M(  168, -117), M(  -36,  -45), M(  120, -132), M(  -27,  -45), M(  -21,  -39),
        M(    0,   12), M(  -42,   -3), M(  -42,  -45), M(   87, -126), M(   21,  -54), M(  102,  -60), M(   99,  -81), M(  138,  -99), M(   99,  -99), M(  237,  -81), M(  -30,  -27), M(  -42,  -42), M(   27,  -72), M(  111,  -99), M(   15,   12),
        M(   -3,    0), M(   48,  -27), M(   72,  -42), M(   78,  -81), M(   63,   -6), M(  183, -108), M(  117,  -57), M(  207,  -87), M(   99,  -42), M(  123,  -51), M(  243,  -66), M(   45,  -39), M(   24,  -18), M(   27,  -24), M(   39,  -21),
        M(   36,  -45), M(   42,  -30), M(   33,   -9), M(   99,  -15), M(  117,  -54), M(  195,  -30), M(   48,  -48), M(  120,  -36), M(   -3,  -24), M(  114,   21), M(   99,  -45), M(   57,   15), M(   48,   -6), M(   84,  -42), M(   -3,   -3),
        M(  -12,   30), M(  -15,  -12), M(    6,   -3), M(   18,  -12), M(   18,    3), M(  -12,  -21), M(   48,   33), M(  360,  -87), M(  153,  135), M(  -42,  -15), M(    6,    3), M(    6,   -9), M(   -3,   -3), M(  -21,   -3), M(   -6,    6),
        M(    6,    9), M(   -9,   18), M(   -6,   18), M(    6,   15), M(   12,   27), M(    9,    9), M(  234,  -69), M(    0,    0), M(   72,  -63), M(  -21,   18), M(   24,   18), M(    6,   12), M(    0,    9), M(    0,   12), M(   -6,   27),
        M(   -3,   15), M(    3,  -18), M(    0,  -15), M(    9,  -21), M(   -3,   12), M(   24,  -18), M(   30,   69), M(  105,   84), M(   24,   63), M(   -3,   -6), M(    3,   -6), M(    3,  -18), M(    6,  -15), M(    0,   -6), M(  -12,   21),
        M(  -15,   45), M(   -3,   21), M(   -3,   24), M(    9,   27), M(    9,   24), M(   48,   30), M(   -9,   -3), M(   -6,    6), M(   12,  -27), M(    9,   39), M(    6,    6), M(    0,   24), M(    0,   12), M(    3,    6), M(   -6,   27),
        M(  -15,   33), M(   -3,    3), M(    3,    0), M(    9,  -21), M(  -15,   12), M(   -3,   12), M(    3,   12), M(    6,   21), M(    3,    6), M(   -3,    0), M(   -3,   -6), M(    0,  -12), M(    3,   -6), M(    0,    0), M(    0,    3),
        M(  -18,   15), M(    3,    9), M(    0,   -6), M(    0,   -6), M(   -3,    9), M(    3,   18), M(    6,    0), M(    0,    0), M(    3,   -6), M(    3,    9), M(   -3,    3), M(    0,    0), M(    0,   -3), M(    3,    0), M(    0,    0),
        M(   -6,    9), M(   -3,   -3), M(    3,  -15), M(    3,   -3), M(    0,    9), M(   -3,    9), M(    6,    3), M(    0,    6), M(    3,    0), M(    0,    0), M(    3,    0), M(    0,   -3), M(    3,  -12), M(    0,    0), M(   -6,   27),
        M(    0,    6), M(   -3,    0), M(    0,   -6), M(    3,   -3), M(    0,    0), M(   -3,    3), M(    0,    6), M(    6,    3), M(    0,    3), M(    0,    0), M(    0,   -3), M(    0,    0), M(    0,   -6), M(    0,   -9), M(    0,    6),
        M(  -15,   -3), M(    0,    3), M(   -3,    3), M(    0,   -3), M(   -6,    0), M(   -6,    0), M(    3,   -6), M(    6,   -6), M(   -3,   12), M(    0,    0), M(    0,    0), M(   -3,    6), M(   -3,    6), M(    0,   -6), M(   -3,    9),
    },
};
