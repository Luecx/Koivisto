...
// 2020-10-24 06:56:46,520 INFO     Testing {'FUTILITY_MARGIN': 98, 'RAZOR_MARGIN': 318, 'LMR_DIV': 190, 'LMR_BONUS': 0.3417698202062327}

int RAZOR_MARGIN     = 318;
int FUTILITY_MARGIN  =  98;
int SE_MARGIN_STATIC =   0;
int LMR_DIV          = 190;
float LMR_BONUS      =   0.341;
void initLmr() {
    int d, m;
