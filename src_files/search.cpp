...
// null Move stuff
int NULL_QSDROP_DEPTH       = 4;
int NULL_QSDROP_MARGIN      = 28;
int NULL_NOQSDROP_MARGIN    = 0;
int NULL_ENEMYTHREAT_DEPTH  = 6;
int NULL_EVAL_DIV           = 85;
int NULL_DEPTH_DIV          = 3;

// see margins
int SEE_MARGIN_QUIET        = 37;
