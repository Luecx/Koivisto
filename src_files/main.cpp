...
void main_tune_features() {
    ...
    auto K = tuning::computeK(2.49908, 200, 1e-7, 16);
    //    double K = 2.5;
    for (int i = 0; i < 10; i++) {
        ...
        std::cout << tuning::optimisePSTBlackBox(K, pinnedEval, 15, 50, 1, 16) << std::endl;
        std::cout << tuning::optimisePSTBlackBox(K, hangingEval, 5, 50, 1, 16) << std::endl;
        std::cout << tuning::optimisePSTBlackBox(K, evfeatures, 21, 50, 1, 16) << std::endl;
        //        std::cout << tuning::optimisePSTBlackBox(K, &bishop_pawn_same_color_table_o[0], 9, 100, 1, 2) <<
        //        std::endl; std::cout << tuning::optimisePSTBlackBox(K, &bishop_pawn_same_color_table_e[0], 9, 100, 1,
        //        2) << std::endl;
        //
