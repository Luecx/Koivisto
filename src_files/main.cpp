...
void main_tune_features() {
    ...
    for (int i = 0; i < 5000; i++) {
        ...
        std::cout << tuning::optimisePSTBlackBox(K, &pieceScores[0], 6, 1, 2) << std::endl;
        //std::cout << tuning::optimisePSTBlackBox(K, &evfeatures[0], 22, 1, 4) << std::endl;
