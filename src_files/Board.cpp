...
Score Board::evaluate(){
    ...
    constexpr float evaluation_scalar_table[9 * 3 * 3 * 3 * 2]{
        1         , 1.36313   , 1.33751   , 1.2657    , 1.1457    ,  //
        0.855547  , 0.926933  , 0.972934  , 1.02381   , 1.01369   ,  //       q
        1.0561    , 0.91854   , 1.01818   , 1.04013   , 1.05757   ,  //     r
        1.05865   , 1.04566   , 1.038     , 1.03626   , 1.0424    ,  //     r q
        0.956735  , 1.03214   , 1.04167   , 1.03896   , 1.03709   ,  //     rr
        0.855908  , 0.933328  , 0.959468  , 1.0119    , 1.08518   ,  //     rrq
        0.635451  , 0.66454   , 0.951118  , 1.02524   , 1.01504   ,  //   b
        0.893947  , 1.00501   , 1.04171   , 1.02874   , 1.03138   ,  //   b   q
        0.912245  , 1.01193   , 1.0362    , 1.04497   , 1.05456   ,  //   b r
        1.03845   , 1.0368    , 1.03608   , 1.04577   , 1.07214   ,  //   b r q
        0.997591  , 1.1055    , 1.0468    , 1.05935   , 1.05452   ,  //   b rr
        1.00498   , 1.01822   , 1.03656   , 1.05794   , 1.09394   ,  //   b rrq
        0.660866  , 0.95289   , 1.03817   , 1.08231   , 1.08875   ,  //   bb
        0.959371  , 1.05086   , 1.0446    , 1.04437   , 1.04492   ,  //   bb  q
        0.95845   , 1.07303   , 1.09183   , 1.06513   , 1.06526   ,  //   bbr
        0.959992  , 1.01195   , 1.04218   , 1.12144   , 1.11304   ,  //   bbr q
        1.13254   , 1.08455   , 1.08738   , 1.12397   , 1.06294   ,  //   bbrr
        1.03663   , 1.03851   , 1.05781   , 1.07364   , 1.10302   ,  //   bbrrq
        0.637384  , 0.724236  , 0.960808  , 1.06451   , 1.10442   ,  // n
        0.855245  , 1.00218   , 1.03581   , 1.03917   , 1.03743   ,  // n     q
        0.857854  , 1.00648   , 1.03582   , 1.04302   , 1.0522    ,  // n   r
        1.08531   , 1.04255   , 1.04185   , 1.05924   , 1.09094   ,  // n   r q
        0.925951  , 1.0702    , 1.03642   , 1.03699   , 1.04966   ,  // n   rr
        0.728138  , 1.0319    , 1.03917   , 1.0383    , 1.10344   ,  // n   rrq
        0.700438  , 0.970542  , 1.04097   , 1.04419   , 1.04279   ,  // n b
        0.881714  , 1.06758   , 1.12327   , 1.08513   , 1.04438   ,  // n b   q
        0.881723  , 1.11341   , 1.1052    , 1.06284   , 1.05033   ,  // n b r
        1.08485   , 1.03599   , 1.05396   , 1.11587   , 1.11043   ,  // n b r q
        1.07753   , 1.10794   , 1.06487   , 1.08639   , 1.06045   ,  // n b rr
        1.06291   , 1.03627   , 1.03824   , 1.11013   , 1.10709   ,  // n b rrq
        0.997951  , 1.11162   , 1.18469   , 1.1662    , 1.05466   ,  // n bb
        0.898931  , 1.19672   , 1.15272   , 1.14675   , 1.06824   ,  // n bb  q
        0.998868  , 1.08555   , 1.08808   , 1.08283   , 1.06819   ,  // n bbr
        1.0437    , 0.999332  , 1.0786    , 1.10664   , 1.11967   ,  // n bbr q
        0.941245  , 1.12164   , 1.12339   , 1.09491   , 1.06293   ,  // n bbrr
        1.0065    , 0.957362  , 1.03949   , 1.06997   , 1.10255   ,  // n bbrrq
        0.639268  , 0.701733  , 0.950789  , 0.999003  , 1.0363    ,  // nn
        0.719167  , 0.914061  , 1.03678   , 1.04106   , 1.03613   ,  // nn    q
        0.717157  , 1.01282   , 1.04374   , 1.03633   , 1.0365    ,  // nn  r
        0.940135  , 1.18973   , 1.08686   , 1.09779   , 1.10208   ,  // nn  r q
        1.03374   , 1.08868   , 1.05693   , 1.04646   , 1.03851   ,  // nn  rr
        1.00808   , 0.948661  , 1.03616   , 1.08685   , 1.09121   ,  // nn  rrq
        0.653897  , 0.947037  , 1.0384    , 1.06944   , 1.03599   ,  // nnb
        0.94918   , 1.03581   , 1.0968    , 1.0562    , 1.08147   ,  // nnb   q
        0.852011  , 1.01684   , 1.08112   , 1.06778   , 1.04365   ,  // nnb r
        0.734254  , 1.04181   , 1.10888   , 1.1509    , 1.12017   ,  // nnb r q
        0.957403  , 1.17853   , 1.13716   , 1.0766    , 1.05892   ,  // nnb rr
        0.685181  , 1.0125    , 1.17376   , 1.13437   , 1.10744   ,  // nnb rrq
        0.83949   , 1.00581   , 1.14656   , 1.05427   , 1.04427   ,  // nnbb
        1.01527   , 1.16698   , 1.00346   , 1.10106   , 1.04387   ,  // nnbb  q
        0.82992   , 0.9881    , 1.12118   , 1.0629    , 1.06142   ,  // nnbbr
        0.669242  , 1.08414   , 1.08971   , 1.1402    , 1.13396   ,  // nnbbr q
        1.27407   , 1.03647   , 1.15204   , 1.16133   , 1.06768   ,  // nnbbrr
        1.35436   , 0.779689  , 1.06489   , 1.05124   , 1.10811   ,  // nnbbrrq
    };
    // clang-format on
    ...
    int table_index =
        + std::min(bitCount(getPieceBB(winning_side, PAWN  )), 4) * 1
        + std::min(bitCount(getPieceBB(winning_side, KNIGHT)), 2) * 5
        + std::min(bitCount(getPieceBB(winning_side, BISHOP)), 2) * 5 * 3
        + std::min(bitCount(getPieceBB(winning_side, ROOK  )), 2) * 5 * 3 * 3
        + std::min(bitCount(getPieceBB(winning_side, QUEEN )), 1) * 5 * 3 * 3 * 3;
    ...
    return (+          evaluation_mg_scalar
           ...
           * nn_evaluation * evaluation_scalar_table[table_index];
