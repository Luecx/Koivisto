...
float Board::phase(){
    return (24.0f + phaseValues[5] - phaseValues[0] * bitCount(getPieceBB()[WHITE_PAWN] | getPieceBB()[BLACK_PAWN])
...
Score Board::evaluate(){
    return (1.4f + basePhase - phase()) * this->evaluator.evaluate(this->getActivePlayer());
}